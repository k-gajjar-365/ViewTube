         ...
         <div className="text-center p-8 rounded-xl bg-[#151515] shadow-2xl shadow-black md:w-120 lg:w-180">
            ...
            <form className="flex flex-col font-mono p-5 gap-10 mb-2">
               ...
               <button
                  ...
                  className={`${buttonDisabled ? "bg-gray-600 hover:cursor-not-allowed" : "bg-[#ae7aff] hover:bg-[#9f65fd]"} p-3 rounded-lg cursor-pointer transition-all duration-300 shadow-xl shadow-black `}
               >
